...
<html lang="en">
  <head>
    ...
    <!-- Font Awesome -->
    <link href="{!! asset('public/gentelella-master/vendors/font-awesome/css/font-awesome.min.css') !!}" rel="stylesheet">
    <!-- NProgress -->
    <link href="{!! asset('public/gentelella-master/vendors/nprogress/nprogress.css') !!}" rel="stylesheet">
    <!-- jQuery custom content scroller -->
    <link href="{!! asset('public/gentelella-master/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css') !!}" rel="stylesheet">
 ...
 <!-- footer content -->
    ...
    <!-- jQuery custom content scroller -->
    <script src="{!! asset('public/gentelella-master/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') !!}"></script>
